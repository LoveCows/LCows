...
$result = mysql_query("SELECT * FROM user WHERE login='$login'",$db); //извлекаем из базы все данные о пользователе с введенным логином
	...
	echo '<script>window.location.href = "pregame.php";</script>';  // перенаправление на нужную страницу
    echo "Вы успешно вошли на сайт! Травки и добра Вам, пользователь! //<a href='index.php'>Главная страница</a>";
    }
 else {
